...
* NEB (6, nemaline myopathy, expected CN=6)
* PMS2 (2, Lynch Syndrome, expected CN=2)
* RCCX (CAH/congenital adrenal hyperplasia., expected CN=4)
* SMN1 (SMA/spinal muscular atrophy, expected CN=4)

To view the demo, go to: https://pacificbiosciences.github.io/ParaviewerWGSDemo/
